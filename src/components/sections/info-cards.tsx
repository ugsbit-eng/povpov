        ...
        <div ref={cardsRef} className="reveal stagger max-w-[1000px] mx-auto space-y-8">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-border-subtle bg-background-secondary/60 backdrop-blur-sm p-8 lg:p-12 hover:border-primary-green/30 transition-all duration-300">
            <div className="grid md:grid-cols-[200px_1fr] gap-8 items-center">
              ...
              <div>
                <h3 className="text-2xl lg:text-3xl font-bold text-primary-green mb-4 !whitespace-pre-line !whitespace-pre-line !w-full !h-3/6"> 
                  <span className="text-text-secondary !whitespace-pre-line !whitespace-pre-line !whitespace-pre-line !w-full !h-20 !whitespace-pre-line">The Legend of Three Gems  </span>
                </h3>
                <p className="text-base lg:text-lg text-text-secondary leading-relaxed !whitespace-pre-line">In the volatile world of Solana trading, success isn't born from luck. It's engineered through the perfect fusion of experience, innovation, and instinct. The POV Solana Sniper BOT represents the convergence of three extraordinary forces, three legendary gems, each possessing unique powers that alone are formidable, but together are unstoppable.
            ...
            <div className="grid md:grid-cols-[200px_1fr] gap-8 items-center">
              ...
              <div>
                <h3 className="text-2xl lg:text-3xl font-bold text-primary-green mb-4">
                  Peluka Chavez <span className="text-text-secondary !whitespace-pre-line !whitespace-pre-line">The Foundation</span>
                </h3>
                <p className="text-base lg:text-lg text-text-secondary leading-relaxed !whitespace-pre-line !whitespace-pre-line">Before Bitcoin became a household name, Peluka Chavez was already moving thousands of BTC through wallets, witnessing the birth of a revolution. The Backbone with over a decade of blockchain mastery, he doesn't just understand cryptocurrency, he feels it.
          ...
          <div className="relative overflow-hidden rounded-3xl border border-border-subtle bg-background-secondary/60 backdrop-blur-sm p-8 lg:p-12 hover:border-primary-green/30 transition-all duration-300">
            <div className="grid md:grid-cols-[200px_1fr] gap-8 items-center">
              ...
              <div>
                <h3 className="text-2xl lg:text-3xl font-bold text-primary-green mb-4">
                  Obsidian Veil <span className="text-text-secondary !whitespace-pre-line">The Executor</span>
                </h3>
                <p className="text-base lg:text-lg text-text-secondary leading-relaxed !whitespace-pre-line">Ideas are worthless without execution. Obsidian Veil transforms vision into reality, translating complex trading strategies into flawless code that executes with surgical precision.
          ...
          <div className="relative overflow-hidden rounded-3xl border border-border-subtle bg-background-secondary/60 backdrop-blur-sm p-8 lg:p-12 hover:border-primary-green/30 transition-all duration-300">
            <div className="grid md:grid-cols-[200px_1fr] gap-8 items-center">
              ...
              <div>
                <h3 className="text-2xl lg:text-3xl font-bold text-primary-green mb-4">
                  Sniper <span className="text-text-secondary !whitespace-pre-line">The Market Predator</span>
                </h3>
                <p className="text-base lg:text-lg text-text-secondary leading-relaxed !whitespace-pre-line">Two gems possessed knowledge and skill, but the puzzle remained incomplete. Enter Sniper the missing element that transformed potential into profit.
